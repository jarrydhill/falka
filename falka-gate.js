...
(function () {
    ...
    function gateHTML() {
        return [
            ...
            '  <h1 class="fg-headline">Australian power catamarans, <em>considered</em>.</h1>',
            '  <p class="fg-body">FALKA Yachtworks is preparing for launch. Enter the access code if you have one, or get in touch for enquiries and a first look.</p>',
    ...
    function gateCSS() {
        return [
            ...
            '    background: #1f3028 url("/falka-images/running-serenity.jpeg") center/cover no-repeat;',
            '    animation: fg-zoom 18s cubic-bezier(.22,.61,.36,1) forwards;',
            '}',
            '@keyframes fg-zoom { from { transform: scale(1.08); } to { transform: scale(1); } }',
            '#falka-gate .fg-overlay {',
            '    position: absolute; inset: 0;',
            '    background: linear-gradient(180deg, rgba(14,18,20,0.55) 0%, rgba(14,18,20,0.4) 35%, rgba(14,18,20,0.82) 100%);',
            '}',
            '#falka-gate .fg-inner {',
            ...
            '    gap: 6px; line-height: 1; margin-bottom: 2.5rem;',
            ...
            '}',
            '#falka-gate .fg-input-row:focus-within { border-bottom-color: #d9bd85; }',
            '#falka-gate input {',
            ...
            '#falka-gate .fg-contact a:hover { color: #fff; border-bottom-color: #d9bd85; }',
