...
(function () {
    ...
    function gateCSS() {
        return [
            ...
            '    background:',
            '        radial-gradient(ellipse at 50% 38%, rgba(46,68,99,0.55) 0%, rgba(26,43,64,0) 55%),',
            '        radial-gradient(ellipse at 50% 100%, rgba(11,21,36,0.7) 0%, rgba(11,21,36,0) 60%),',
            '        linear-gradient(180deg, #1a2b40 0%, #16263b 60%, #0b1524 100%);',
            '}',
