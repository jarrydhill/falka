...
(function () {
    ...
    function gateHTML() {
        return [
            ...
            '    <span class="fg-mono" aria-hidden="true">F</span>',
            '    <span class="fg-stack">',
    ...
    function gateCSS() {
        return [
            ...
            '    font-size: 34px; color: #F7F4ED;',
            '    padding-bottom: 0.08em;',
            '}',
            '#falka-gate .fg-stack { display: flex; flex-direction: column; gap: 3px; text-align: left; }',
            '#falka-gate .fg-name {',
            ...
            '    #falka-gate .fg-mono { width: 42px; height: 42px; font-size: 26px; }',
            '    #falka-gate .fg-name { font-size: 22px; }',
            '}'
        ].join('\n');
    }
